...
- **Role-Based Access**: Regular users (citizens/businesses) can create and manage events; Admins (caseworkers) can review, edit, and approve/reject events
...
- View their own events (draft/submitted + review badges: Ubehandlet, Under behandling, Delvist godkendt, Godkendt, Afvist)
